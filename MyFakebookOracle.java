...
public class MyFakebookOracle extends FakebookOracle {
	...
	try{
            Statement stmt=oracleConnection.createStatement();
            ResultSet rst=stmt.executeQuery("SELECT U1, U2, COUNT(*) AS CNT FROM( SELECT F1.USER1_ID AS U1, F2.USER1_ID AS U2 FROM "+friendsTableName+
                ...
                friendsTableName+" F WHERE F.USER1_ID = U1 AND F.USER2_ID = U2) GROUP BY U1, U2 ORDER BY CNT DESC, U1, U2");
